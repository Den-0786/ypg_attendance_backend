...
urlpatterns = [
    ...
    path('api/attendance-summary', get_attendance_summary, name='api_attendance_summary'),
    path('apology-summary', get_apology_summary, name='apology_summary'),
    path('api/apology-summary', get_apology_summary, name='api_apology_summary'),
    path('local-attendance', local_attendance, name='local_attendance'),
    path('api/local-attendance', local_attendance, name='api_local_attendance'),
    path('district-attendance', district_attendance, name='district_attendance'),
    path('api/district-attendance', district_attendance, name='api_district_attendance'),
    path('delete-attendance/<int:pk>', delete_attendance, name='delete_attendance'),
    path('api/delete-attendance/<int:pk>', delete_attendance, name='api_delete_attendance'),
    path('edit-attendance/<int:pk>', edit_attendance, name='edit_attendance'),
    path('api/edit-attendance/<int:pk>', edit_attendance, name='api_edit_attendance'),
    path('delete-apology/<int:pk>', delete_apology, name='delete_apology'),
    path('api/delete-apology/<int:pk>', delete_apology, name='api_delete_apology'),
    path('edit-apology/<int:pk>', edit_apology, name='edit_apology'),
    path('api/edit-apology/<int:pk>', edit_apology, name='api_edit_apology'),
