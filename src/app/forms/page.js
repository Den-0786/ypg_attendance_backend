  ...
  if (showMeetingForm) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-50 to-white p-6">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md text-center border-2 border-yellow-400">
          <h2 className="text-2xl font-bold text-yellow-700 mb-4">No Active Meeting</h2>
          <p className="text-gray-600 mb-6">
            Please contact the executive to set up a meeting before you can submit attendance.
          </p>
          <button
            onClick={handleLogout}
            className="px-6 py-2 bg-yellow-500 text-white rounded-xl hover:bg-yellow-600 transition"
          >
            Logout
          </button>
        </div>
