...
export default function DashboardHome({
  ...
  const progressCardClass =
    "flex flex-col justify-between items-center p-4 rounded-xl shadow-md min-w-[220px] max-w-xs w-full";
    ...
    <div>
      ...
      <div className="flex gap-4 mb-6 mt-2 items-center overflow-x-auto custom-scrollbar snap-x snap-mandatory pl-8 pr-4">
        <div
          className={
            progressCardClass +
            " bg-blue-700 text-white min-w-[260px] snap-start"
          }
        >
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-16 h-16 flex items-center justify-center">
              <svg width="64" height="64" viewBox="0 0 64 64">
                ...
                <circle
                  ...
                  strokeDashoffset={
                    2 * Math.PI * 28 * (1 - localProgress / 100)
                  }
                  strokeLinecap="round"
                  style={{
                    transition:
                      "stroke-dashoffset 0.6s cubic-bezier(.4,2,.3,1)",
                  }}
                />
                <defs>
                  <linearGradient
            ...
            <div className="flex flex-col text-sm">
              ...
              <span>
                Current Year: {selectedYear || new Date().getFullYear()}
              </span>
            </div>
          </div>
        </div>
        <div
          className={
            progressCardClass +
            " bg-green-700 text-white min-w-[260px] snap-center"
          }
        >
          <div className="font-semibold text-lg mb-2">
            ...
            <div className="relative w-16 h-16 flex items-center justify-center">
              <svg width="64" height="64" viewBox="0 0 64 64">
                ...
                <circle
                  ...
                  strokeDasharray={2 * Math.PI * 28}
                  strokeDashoffset={
                    2 * Math.PI * 28 * (1 - districtProgress / 100)
                  }
                  strokeLinecap="round"
                  style={{
                    transition:
      ...
      <div className="overflow-x-auto md:overflow-x-visible custom-scrollbar">
        <div className="flex md:grid md:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6 min-w-max md:min-w-0">
          <div className="p-3 md:p-4 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-800 rounded-lg shadow-sm">
            <h3 className="text-xs md:text-sm font-semibold text-blue-700 dark:text-blue-300">
              Total Records
            </h3>
          ...
          <div className="p-3 md:p-4 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-800 rounded-lg shadow-sm">
            <h3 className="text-xs md:text-sm font-semibold text-green-700 dark:text-green-300">
          ...
          <div className="p-3 md:p-4 bg-purple-50 dark:bg-purple-900 border border-purple-200 dark:border-purple-800 rounded-lg shadow-sm">
            <h3 className="text-xs md:text-sm font-semibold text-purple-700 dark:text-purple-300">
              Total Meetings
            </h3>
          ...
          <div className="p-3 md:p-4 bg-amber-50 dark:bg-orange-900 border border-amber-200 dark:border-amber-800 rounded-lg shadow-sm">
            <h3 className="text-xs md:text-sm font-semibold text-amber-700 dark:text-orange-300">
              Grand Total Progress
            </h3>
            <p className="text-lg md:text-xl font-bold text-amber-900 dark:text-orange-100">
              {getGrandTotalProgress(filteredData, selectedYear)}%
            </p>
          </div>
        </div>
      </div>
        ...
        Object.keys(groupedSummary).length === 0 ? (
          <div className="text-center py-8">
            <div className="text-gray-500 dark:text-gray-400 text-lg font-medium">
              No {showType === "all" ? "attendance or apology" : showType} data
              available
            </div>
                            ...
                            <table className="min-w-max w-full text-gray-900 dark:text-gray-100 mb-2 border-collapse">
                              ...
                              >
                                <tr>
                                  ...
                                  <th className="text-left px-2 md:px-4 py-2 border-r border-gray-300 text-xs md:text-sm">
                                    Submitted Time
                                  </th>
                                  <th className="text-left px-2 md:px-4 py-2 border-r border-gray-300 text-xs md:text-sm">
                                    Status
                ...
                onClick={async () => {
                  if (pendingUndoApology) {
                    ...
                    if (res.ok) {
                      ...
                      if (refetchApologyData) refetchApologyData();
                      window.dispatchEvent(
                        new CustomEvent("apologyDataChanged")
                      );
