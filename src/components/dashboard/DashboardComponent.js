...
export default function DashboardComponent(props) {
  ...
  // Placeholder for district executive (can be dynamic later)
  const currentDistrictExecutive = 'All District Executives';

  return (
    <>
      {/* All dashboard content inside the same scrollable container */}
      {/* Top Info Cards - each in its own card */}
      <div className="w-full flex flex-col md:flex-row gap-4 mb-8">
        <div className="flex-1 bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-6 flex flex-col items-center border border-gray-200 dark:border-gray-700">
          <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Month</span>
          <span className="text-lg font-bold text-gray-800 dark:text-gray-100">{currentMonth}</span>
        </div>
        <div className="flex-1 bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-6 flex flex-col items-center border border-gray-200 dark:border-gray-700">
          <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">District Executive</span>
          <span className="text-lg font-bold text-gray-800 dark:text-gray-100">{currentDistrictExecutive}</span>
        </div>
        <div className="flex-1 bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-6 flex flex-col items-center border border-gray-200 dark:border-gray-700">
          <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Year</span>
          <span className="text-lg font-bold text-gray-800 dark:text-gray-100">{currentYear}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6">
        <div className="p-3 md:p-4 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-800 rounded-lg shadow-sm">
          ...
          <p className="text-lg md:text-xl font-bold text-blue-900 dark:text-blue-100">-</p>
        </div>
        <div className="p-3 md:p-4 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-800 rounded-lg shadow-sm">
          ...
          <p className="text-lg md:text-xl font-bold text-green-900 dark:text-green-100">-</p>
        </div>
        <div className="p-3 md:p-4 bg-purple-50 dark:bg-purple-900 border border-purple-200 dark:border-purple-800 rounded-lg shadow-sm">
          ...
          <p className="text-lg md:text-xl font-bold text-purple-900 dark:text-purple-100">-</p>
        </div>
